...
class DocGeneration(models.Model):
    ...
    # ------------------------------------------------------------------
    # Auto-fill name when module_ids changes
    # ------------------------------------------------------------------
    @api.onchange("module_ids", "module_names")
    def _onchange_auto_name(self):
        """Fill 'name' automatically from selected modules when it is still default."""
        default_names = {
            _("\u041d\u043e\u0432\u044b\u0439 \u0437\u0430\u043f\u0443\u0441\u043a"),
            "New Run",
            "",
    ...
    def action_enrich_all_modules(self):
        """\u0417\u0430\u043f\u0443\u0441\u0442\u0438\u0442\u044c \u043e\u0431\u043e\u0433\u0430\u0449\u0435\u043d\u0438\u0435 \u0432\u0441\u0435\u0445 \u043c\u043e\u0434\u0443\u043b\u0435\u0439 \u0438\u0437 \u0441\u043d\u0430\u043f\u0448\u043e\u0442\u0430 \u0431\u0435\u0437 \u043f\u043e\u0432\u0442\u043e\u0440\u043d\u043e\u0433\u043e Collect."""
        self.ensure_one()
